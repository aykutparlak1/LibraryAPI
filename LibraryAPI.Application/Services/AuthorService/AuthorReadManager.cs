...
namespace LibraryAPI.Application.Services.AuthorService
{
    public class AuthorReadManager : IAuthorReadService
    {
        ...
        private AuthorBusinessRules _authorBusinessRules;
        ...
        {
           var result =  await _authorReadRepository.GetAll(null, false).ToListAsync();
        ...
        {
            var result = await _authorReadRepository.GetAsync(x=>x.Id == id,false);
